...
from .get_currency_handler import router as get_currency_router
from .admin_message_broadcast_handler import router as admin_message_broadcast_router
...
router.include_router(get_currency_router)
router.include_router(admin_message_broadcast_router)
